...
1. WindowsのエクスプローラーなどでJPCOAR Schema Helperを保存したフォルダを開きます。
...
1. WindowsのエクスプローラーなどでJPCOAR Schema Helperを保存したフォルダを開き、`work`フォルダの中に新しいフォルダを作成します。フォルダ名は資料名などわかりやすいものであれば、なんでもかまいません。ここでは`work`フォルダの中に`my_article`フォルダを作ったこととして、以降そのフォルダを`work/my_article`フォルダと記述します。
